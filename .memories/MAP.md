...
| `src/context/mod.rs` | Context-compaction ladder, peer of `semantic/` — module doc points at `.docs/context-compaction.md`; re-exports `budget::{ContextBudget, budget_tokens, conversation_tokens}`, `spec::ContextSpec`, `tool_output::cap_tool_output`; `PRUNE_TRIGGER_PERCENT` (70) gates rung 1 |

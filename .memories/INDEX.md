# .memories INDEX
> Agent entry point. If you were handed this project cold, START HERE. Last updated: 2026-07-04 (`/rate` per-minute cap + confirmation messages, `/debug` runtime toggle, stats-panel Rate row, input-history-after-submit fix — clippy 0, tests 223, MSRV 1.91)
